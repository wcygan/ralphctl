...
- [ ] Create templates/SPEC.md with section headers only
- [ ] Create templates/IMPLEMENTATION_PLAN.md with section headers only
- [ ] Create templates/PROMPT.md with full ralph orchestration prompt
